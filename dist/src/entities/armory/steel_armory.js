...
let SteelArmory = class SteelArmory {
    constructor(pauldron, gauntlet, helmet, boots) {
...
SteelArmory = __decorate([
    ...
    __param(1, (0, inversify_1.inject)(identifiers_1.default.GAUNTLET)),
    __param(2, (0, inversify_1.inject)(identifiers_1.default.HELMET)),
